...
public class MediaLibRunner
{
  public static void main(String[] args)
  {
    ...
    */
    ...
    System.out.println(newBook2 + " equal " + newBook + "? "  + newBook2.equals(newBook));
    Movie newMovie = new Movie("Avengers Endgame", "Stan Lee");
    MediaLib newMedia = new MediaLib();
    newMedia.addMovie(newMovie);
    System.out.println(newMedia);
    Movie movietwo = new Movie("E.T", "Marcus Rashford");
    newMedia.addMovie(movietwo);
    System.out.println("newMedia");
    // Step 27 - 28
